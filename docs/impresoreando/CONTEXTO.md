...
| Logo | `index/clientes/impresoreando/identidad/logo-impresoreando.png` (fondo transparente) · variantes `…-claro.png` · `…-oscuro.png` · ícono `icono-gato-impresoreando.svg` · ver `IDENTIDAD.md` |
