...
| Logo | `index/clientes/impresoreando/identidad/logo-impresoreando.png` (+ `.svg`) · variantes `…-transparente.png` · `…-claro.png` · ícono `icono-gato-impresoreando.svg` · ver `IDENTIDAD.md` |
