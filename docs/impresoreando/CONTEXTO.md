...
| Logo | `identidad/logo-ima2.png` (= `logo-oficial-ui.png`) · **Editar logo** en landing/panel · `PROMOVER-LOGO-IMP.bat` / `ABRIR-LARAVEL` lo dejan canónico · ver `IDENTIDAD.md` |
...
| ~~PED-007~~ | Juan SIE | 1× Torreón `TORREON001` | **eliminado** |
