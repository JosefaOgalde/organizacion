# Postulaciones laborales · Mi perfil

**Asociación:** perfil personal (Josefa Ogalde) — **no** asociar a un cliente del organizador.

## Uso

1. Organizador → pestaña **Mi perfil** → carta, contacto, notas.
2. Material de postulaciones (avisos, borradores, checklist) → esta carpeta / este archivo.
3. Tareas del calendario: crear con **Sin cliente** o tipo personal; no usar `cli-tronwell` ni otros `cli-*`.
...
- Carta de presentación: campo en **Mi perfil** (`perfilPersonal.cartaPresentacion`)
- PDF / tarjeta: `index/assets/perfil/`
- Contacto: `josefaogalde@gmail.com` · WhatsApp +56 9 6604 7614 · GitHub JosefaOgalde
