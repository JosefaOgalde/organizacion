...
Handoff para continuidad entre agentes. **Última actualización: 6 jul 2026.**
...
- [x] Query Woo configurada por colección (usuario confirmó)
- [x] Títulos pequeños Gold/Deluxe eliminados del widget
- [x] Ocultar Sin categorizar
- [x] Forzar etiqueta Gold/Deluxe en tarjetas (CSS)

### Pendiente

- [ ] **Asignar subcategorías o etiquetas a todos los productos** — sin esto, Todas funciona pero Pulseras/Aros/etc. muestran vacío
- [ ] D06 Paso 5: cabecera «X productos» + orden Destacados (si el widget lo permite)
- [ ] Responsive móvil: panel oculto (CSS ya lo hace); definir alternativa móvil (círculos del hero)
- [ ] Marcar D06 completada en organizador
- [ ] D12 Ayuda (pausada)
- [ ] D08 opcional: Filter Everything para AJAX robusto
