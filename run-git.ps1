...
git add app.js index.html styles.css README.md docs .gitignore SUBIR.bat run-git.ps1 do-commit.ps1 .vscode .cursor scripts IMPORTAR-RESPALDO.bat .env.example ABRIR-LARAVEL.bat ABRIR-ORGANIZADOR-HOY.bat CERRAR-SERVIDOR.bat 2>&1 | Out-Null
