...
- Ecosistema NL agosto: calendario **NL 1 = 21 jul** · **NL 2 = 23 jul** (pub LinkedIn 1/2 ago). Crear/fechas: `ASEGURAR-ECR-NL-CALENDARIO.bat`. Portada NL 1 hecha. Copys: `newsletter/copys/`. Landing ECR: sección ecosistema NL.
