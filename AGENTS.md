...
Resumen 1 línea: panel `…/impresoreando/panel/` · live `data/impresoreando-live.json` · API `/api/impresoreando` · pedidos `PED-00n` · ventas `I00000n` · historial · solo ventas bajan deuda · PLA+ negro `$17986/kg` · impresoras: Centauri (default) + **Ender 3 V2 Neo Sprite Neo** (antigua / otro filamento).
