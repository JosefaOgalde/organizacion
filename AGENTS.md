...
- Ecosistema NL agosto: **NL 1 = 20 ago** · **NL 2 = 22 ago**. Fechas + Portada NL 1 hecha: `ACTUALIZAR-ECR-NL-AGOSTO.bat` / `node scripts/actualizar-fechas-ecr-nl-agosto.js` → `?disco=1`. Copys: `newsletter/copys/`. Landing ECR: sección ecosistema NL.
