<?php
/**
 * Cierra la subtarea 2 (Copys video) de la madre [TS] Contenido 9/12.
 *
 *   php scripts/finalizar-ts-c09-copy.php
 *   (o doble clic en FINALIZAR-TS-C09-COPY.bat)
 *
 * Luego: http://127.0.0.1:8000/index.html?disco=1&tarea=trendseeker/15
 */

$root = dirname(__DIR__);
$live = $root . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . 'organizacion-live.json';
$id = 'tarea-ts-contenido-9-de-12-copy';
...
if ($idx === null) {
    ...
    fwrite(STDERR, "En el organizador debe existir [TS] C9/12 — Copys video.\n");
    exit(1);
}

$data['tareas'][$idx]['completada'] = true;
$data['tareas'][$idx]['pendiente'] = false;
$data['tareas'][$idx]['entregableArchivo'] =
    'index/clientes/trendseeker/copys/COPY-c09-play-bajas-rojo-mujer-C.txt';
$data['tareas'][$idx]['notas'] =
    'FINALIZADO 2026-07-21. Copy elegida C (checklist + contexto/emojis + CTA 50% OFF). TXT: index/clientes/trendseeker/copys/COPY-c09-play-bajas-rojo-mujer-C.txt · Link: https://trendseeker.cl/producto/botas-de-agua-bajas-play-para-mujer-rojo/';
...
echo "Abre http://127.0.0.1:8000/index.html?disco=1&tarea=trendseeker/15\n";
