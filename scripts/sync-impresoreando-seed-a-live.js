...
function main() {
  ...
  // Quitar solo el registro duplicado conocido. El número PED-012 puede pertenecer
  // a otro pedido legítimo en un live local y no identifica al duplicado histórico.
