  ...
  function slidePortada() {
    return `
      <article class="slide slide--portada" data-slide="0" aria-label="Portada">
        <img class="slide-logo" src="../identidad/logo-imp-ui-20260729.png?v=imp-ui-20260729" alt="impresoreando" width="820" height="150" />
    ...
    return `
      <article class="slide slide--cierre" data-slide="${total - 1}" aria-label="Cierre">
        <div class="slide-cierre-logo-wrap">
          <img class="slide-logo-cierre" src="../identidad/logo-imp-ui-20260729.png?v=imp-ui-20260729" alt="impresoreando" width="720" height="132" />
        </div>
