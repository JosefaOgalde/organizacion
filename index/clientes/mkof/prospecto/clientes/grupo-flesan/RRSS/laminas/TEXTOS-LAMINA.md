# Instagram · textos para lámina 02 · Grupo Flesan (Prospecto)

Fuente: capturas perfil + 5 contenidos IG 2026-07-28 · `../data/ig-er-flesan-muestra.json`  
JSON: `../../data/ecosistema-competencia.json`

---

## 02 · ECOSISTEMA DE RRSS COMPETENCIA

**Título:** ECOSISTEMA DE RRSS COMPETENCIA  
**Sujeto / logo:** Grupo Flesan  
**Canal:** Instagram (@grupoflesan)

### FORMATOS
- Carruseles / fotos de obra con overlay de marca
- Collabs multi-marca (Grupo + DVC / Flesan.ic)
- Piezas con ficha técnica de proyecto

### TEMÁTICAS
- Avance y entrega de obras (infraestructura, educación, frontera)
- Obras públicas (MOP / Serviu / Aduanas)
- Hitos institucionales (primera piedra, inauguraciones)
