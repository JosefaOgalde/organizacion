(function () {
  ...
  banner.innerHTML =
    ...
    '</ol>' +
    '<p class="file-protocol-banner__nota">Ficha JM: <code>/index/clientes/joyasmercury/</code> · ' +
    'La carpeta <code>JoyasMercury/</code> (con mayúsculas) solo guarda capturas PNG, no es la ficha.</p>';
