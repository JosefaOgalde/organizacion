...
window.MOVA_AUTH_TODO_SEED = [
  ...
  },
  {
    ...
    entregable: 'Mapa-mova_auth-nucleo.md + mova-d3-nucleo.html',
    checklist: [
    ...
    enlaces: [
      'index/clientes/MKOF/MOVA/documentos/ver.html?id=d3-nucleo-mova-auth',
      'index/clientes/mkof/Mapa-mova_auth-nucleo.md',
      'index/clientes/mkof/mova-d3-nucleo.html',
      'index/clientes/mkof/Inventario-MOVA-modulos.md'
    ]
  },
  {
    ...
    entregable: 'Flujo-login-cookie-mova_auth.md + mova-d4-login-cookie.html',
    checklist: [
    ...
    enlaces: [
      'index/clientes/MKOF/MOVA/documentos/ver.html?id=d4-login-cookie',
      'index/clientes/mkof/Flujo-login-cookie-mova_auth.md',
      'index/clientes/mkof/mova-d4-login-cookie.html',
  ...
  },
  {
    ...
    entregable: 'Matriz-validacion-modulos-mova_auth.md + mova-d5-validacion.html',
    checklist: [
    ...
    enlaces: [
      'index/clientes/MKOF/MOVA/documentos/ver.html?id=d5-validacion-modulos',
      'index/clientes/mkof/Matriz-validacion-modulos-mova_auth.md',
      'index/clientes/mkof/mova-d5-validacion.html',
      'index/clientes/mkof/Inventario-MOVA-modulos.md'
    ]
  }
];
