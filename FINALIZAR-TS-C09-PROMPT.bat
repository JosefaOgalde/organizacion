...
cd /d "%~dp0"
echo.
echo  === TS · Cerrar subtarea Prompt Gemini C9/12 ===
echo.
...
"%PHP_EXE%" scripts\finalizar-ts-c09-prompt.php
if errorlevel 1 (
  echo.
  pause
  exit /b 1
...
echo    http://127.0.0.1:8000/index.html?disco=1^&tarea=trendseeker/14
echo.
pause
